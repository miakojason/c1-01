<div style="width:99%; height:87%; margin:auto; overflow:auto; border:#666 1px solid;">
    ...
    <form method="post" action="./api/edit.php">
        <table width="100%">
            ...
            ?>
                <tr>
                    <td width="45%"><input type="text[]" name="text" value="<?= $row['text']; ?>"></td>
                    <td width="23%">
                    ...
                    <td>
                        <input type="button" value="編輯次選單" onclick="op('#cover','#cvr','./modal/submenu.php?table=<?= $do; ?>&id=<?= $row['id']; ?>')"><input type="hidden" name="id[]" value="<?= $row['id']; ?>">
                    </td>
                </tr>
            <?php
            }
